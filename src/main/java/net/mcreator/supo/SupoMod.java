...
@Mod("supo")
public class SupoMod {
	public static final Logger LOGGER = LogManager.getLogger(SupoMod.class);
	public static final String MODID = "supo";
